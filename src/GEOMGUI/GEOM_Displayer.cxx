                                       ...
                                       const gp_Ax3& theShapeLCS )
{
  ...
  GEOMUtils_DimensionProperty aRecords;

  if ( aProperty.isValid() && aProperty.canConvert<GEOMUtils_DimensionProperty>() )
  {
    aRecords = aProperty.value<GEOMUtils_DimensionProperty>();
  }
  else
  {
  ...
  for ( int aPrsIt = 0; aPrsIt < aRecords.GetNumber(); ++aPrsIt )
  {
    ...
    {
      case GEOMUtils_DimensionProperty::DimensionType_Length :
      {
      ...
      case GEOMUtils_DimensionProperty::DimensionType_Diameter :
      {
      ...
      case GEOMUtils_DimensionProperty::DimensionType_Angle :
      {
