...
void XCAFSchema_gp_Ax1::SWrite(const gp_Ax1& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginWriteObjectData();
    XCAFSchema_gp_Pnt::SWrite(pp.Location(),f,theSchema);
    XCAFSchema_gp_Dir::SWrite(pp.Direction(),f,theSchema);
...
void XCAFSchema_gp_Ax1::SRead(gp_Ax1& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginReadObjectData();
    ...
    XCAFSchema_gp_Pnt::SRead((gp_Pnt&)pp.Location(),f,theSchema);

    XCAFSchema_gp_Dir::SRead((gp_Dir&)pp.Direction(),f,theSchema);
