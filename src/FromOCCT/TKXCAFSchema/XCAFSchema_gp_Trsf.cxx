...
void XCAFSchema_gp_Trsf::SWrite(const gp_Trsf& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.PutInteger(pp.Form());
    XCAFSchema_gp_Mat::SWrite(pp.HVectorialPart(),f,theSchema);
    XCAFSchema_gp_XYZ::SWrite(pp.TranslationPart(),f,theSchema);
...
void XCAFSchema_gp_Trsf::SRead(gp_Trsf& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginReadObjectData();
    ...
    XCAFSchema_gp_Mat::SRead((gp_Mat&)pp.HVectorialPart(),f,theSchema);

    XCAFSchema_gp_XYZ::SRead((gp_XYZ&)pp.TranslationPart(),f,theSchema);
