...
#endif
#include <StdSchema_gp_Trsf2d.ixx>
...
void StdSchema_gp_Trsf2d::SWrite(const gp_Trsf2d& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.PutInteger(pp.Form());
    StdSchema_gp_Mat2d::SWrite(pp.HVectorialPart(),f,theSchema);
    StdSchema_gp_XY::SWrite(pp.TranslationPart(),f,theSchema);
...
void StdSchema_gp_Trsf2d::SRead(gp_Trsf2d& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginReadObjectData();
    ...
    StdSchema_gp_Mat2d::SRead((gp_Mat2d&)pp.HVectorialPart(),f,theSchema);

    StdSchema_gp_XY::SRead((gp_XY&)pp.TranslationPart(),f,theSchema);
