...
void StdSchema_gp_Ax2d::SWrite(const gp_Ax2d& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginWriteObjectData();
    StdSchema_gp_Pnt2d::SWrite(pp.Location(),f,theSchema);
    StdSchema_gp_Dir2d::SWrite(pp.Direction(),f,theSchema);
...
void StdSchema_gp_Ax2d::SRead(gp_Ax2d& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginReadObjectData();
    ...
    StdSchema_gp_Pnt2d::SRead((gp_Pnt2d&)pp.Location(),f,theSchema);

    StdSchema_gp_Dir2d::SRead((gp_Dir2d&)pp.Direction(),f,theSchema);
