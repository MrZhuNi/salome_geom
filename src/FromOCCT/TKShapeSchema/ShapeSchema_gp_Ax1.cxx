...
void ShapeSchema_gp_Ax1::SWrite(const gp_Ax1& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginWriteObjectData();
    ShapeSchema_gp_Pnt::SWrite(pp.Location(),f,theSchema);
    ShapeSchema_gp_Dir::SWrite(pp.Direction(),f,theSchema);
...
void ShapeSchema_gp_Ax1::SRead(gp_Ax1& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginReadObjectData();
    ...
    ShapeSchema_gp_Pnt::SRead((gp_Pnt&)pp.Location(),f,theSchema);

    ShapeSchema_gp_Dir::SRead((gp_Dir&)pp.Direction(),f,theSchema);
