...
void ShapeSchema_gp_Trsf::SWrite(const gp_Trsf& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.PutInteger(pp.Form());
    ShapeSchema_gp_Mat::SWrite(pp.HVectorialPart(),f,theSchema);
    ShapeSchema_gp_XYZ::SWrite(pp.TranslationPart(),f,theSchema);
...
void ShapeSchema_gp_Trsf::SRead(gp_Trsf& pp, Storage_BaseDriver& f, const Handle(Storage_Schema)& theSchema)
{
  ...
  f.BeginReadObjectData();
    ...
    ShapeSchema_gp_Mat::SRead((gp_Mat&)pp.HVectorialPart(),f,theSchema);

    ShapeSchema_gp_XYZ::SRead((gp_XYZ&)pp.TranslationPart(),f,theSchema);
