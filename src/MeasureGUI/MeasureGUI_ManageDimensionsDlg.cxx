...
void MeasureGUI_ManageDimensionsDlg::PopulateList()
{
  ...
  for ( int anIt = 0; anIt < aProp.GetNumber(); ++anIt )
  {
    ...
    switch ( aType )
    {
      case GEOMUtils_DimensionProperty::DimensionType_Length   : aDistItems << anItem; break;
      case GEOMUtils_DimensionProperty::DimensionType_Diameter : aDiamItems << anItem; break;
      case GEOMUtils_DimensionProperty::DimensionType_Angle    : anAngItems << anItem; break;
    }
  }
...
bool MeasureGUI_ManageDimensionsDlg::WarnUnsaved()
{
  ...
  GEOMUtils_DimensionProperty aCurrentState =
    aStudy->getObjectProperty( GEOM::sharedPropertiesId(),
                               myEditObject->GetStudyEntry(),
                               GEOM::propertyName( GEOM::Dimensions ),
                               QVariant() )
