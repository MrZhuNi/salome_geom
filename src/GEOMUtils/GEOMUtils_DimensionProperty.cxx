...
// File   : GEOMUtils_DimensionProperty.cxx
// Author : Anton POLETAEV, Open CASCADE S.A.S.
//

// GEOMUtils includes
#include "GEOMUtils_DimensionProperty.hxx"
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::Length::Init( const Handle(AIS_LengthDimension)& theIO, const gp_Ax3& theLCS )
{
  gp_Trsf aFromLCS;
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::Length::Update( Handle(AIS_LengthDimension)& theIO, const gp_Ax3& theLCS )
{
  gp_Trsf aToLCS;
...
// purpose  : 
//=================================================================================
bool GEOMUtils_DimensionProperty::Length::operator == (const Length& theOther) const
{
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::Diameter::Init( const Handle(AIS_DiameterDimension)& theIO, const gp_Ax3& theLCS )
{
  gp_Trsf aFromLCS;
  aFromLCS.SetTransformation( gp_Ax3(), theLCS );
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::Diameter::Update( Handle(AIS_DiameterDimension)& theIO, const gp_Ax3& theLCS )
{
  gp_Trsf aToLCS;
  aToLCS.SetTransformation( theLCS, gp_Ax3() );
...
// purpose  : 
//=================================================================================
bool GEOMUtils_DimensionProperty::Diameter::operator == (const Diameter& theOther) const
{
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::Angle::Init( const Handle(AIS_AngleDimension)& theIO, const gp_Ax3& theLCS )
{
  gp_Trsf aFromLCS;
  aFromLCS.SetTransformation( gp_Ax3(), theLCS );
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::Angle::Update( Handle(AIS_AngleDimension)& theIO, const gp_Ax3& theLCS )
{
  gp_Trsf aToLCS;
  aToLCS.SetTransformation( theLCS, gp_Ax3() );
...
// purpose  : 
//=================================================================================
bool GEOMUtils_DimensionProperty::Angle::operator == (const Angle& theOther) const
{
  if ( FirstPoint.X()  != theOther.FirstPoint.X()
    || FirstPoint.Y()  != theOther.FirstPoint.Y()
    || FirstPoint.Z()  != theOther.FirstPoint.Z()
...
// purpose  : 
//=================================================================================
GEOMUtils_DimensionProperty::GEOMUtils_DimensionProperty()
{
}
...
// purpose  : 
//=================================================================================
GEOMUtils_DimensionProperty::GEOMUtils_DimensionProperty( const GEOMUtils_DimensionProperty& theOther )
{
...
// purpose  : 
//=================================================================================
GEOMUtils_DimensionProperty::operator QVariant()
{
  QVariant aQVariant;
...
// purpose  : 
//=================================================================================
bool GEOMUtils_DimensionProperty::operator == (const GEOMUtils_DimensionProperty& theOther) const
{
...
// purpose  : 
//=================================================================================
int GEOMUtils_DimensionProperty::GetNumber() const
{
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::AddRecord( const Handle(AIS_Dimension)& theIO, const gp_Ax3& theLCS )
{
  RecordPtr aNewRecord;
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::AddRecord( const RecordPtr& theRecord )
{
  myVisibility.append( true );
  myNames.append( QString() );
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::RemoveRecord( const int theIndex )
{
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::Clear()
{
  myRecords.clear();
}
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::SetRecord( const int theIndex,
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::SetRecord( const int theIndex, const RecordPtr& theRecord )
{
...
// purpose  : 
//=================================================================================
const GEOMUtils_DimensionProperty::RecordPtr& GEOMUtils_DimensionProperty::GetRecord( const int theIndex ) const
{
...
// purpose  : 
//=================================================================================
bool GEOMUtils_DimensionProperty::IsVisible( const int theIndex ) const
{
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::SetVisible( const int theIndex, const bool theIsVisible )
{
...
// purpose  : 
//=================================================================================
QString GEOMUtils_DimensionProperty::GetName( const int theIndex ) const
{
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::SetName( const int theIndex, const QString &theName )
{
...
// purpose  : 
//=================================================================================
int GEOMUtils_DimensionProperty::GetType( const int theIndex ) const
{
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::LoadFromAttribute( SalomeApp_Study* theStudy,
...
// purpose  : 
//=================================================================================
void GEOMUtils_DimensionProperty::SaveToAttribute( SalomeApp_Study *theStudy,
                                                   const std::string &theEntry )
{
  _PTR(SObject) aSObj = theStudy->studyDS()->FindObjectID( theEntry );
  if ( !aSObj )
...
// purpose  : 
//=================================================================================
int GEOMUtils_DimensionProperty::TypeFromIO( const Handle(AIS_Dimension)& theIO ) const
{
